YAPPL was designed to make it easy to work with probabilities. The following tutorial will give a quick tour of the basics of the language and eventually build up to define a probability distribution and draw samples from it. At the end we highlight unique 
...
To compile a YAPPL file, pass it into the YAPPL compiler, which produces an executable. The following is the basic breakdown of compiling and executing a \texttt{.ypl} file:
