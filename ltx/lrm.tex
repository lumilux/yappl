...
where  \nterm{expr}\textsuperscript{1} \dots \nterm{expr}\textsuperscript{n} are arguments passed to the function. The arguments must match the number and type of the arguments in the declared function being called. 
