...
\newcommand\midtilde{{\hbox{\texttt{\char`\~}}}}
\newcommand{\term}[1]{\texttt{\color{Cyan}#1}}
\newcommand{\nterm}[1]{\textnormal{\em\color{Brown}#1}}

\newcommand{\lstyappllisting}[1]{\lstinputlisting[title=#1, language=YAPPL]{../yappl/#1}}
...
\lstset{basicstyle=\ttfamily, numbers=left, numberstyle=\tiny, numberfirstline=false, stepnumber=1, numbersep=10pt, tabsize=2, belowcaptionskip=2em, abovecaptionskip=3em, breaklines=true, breakatwhitespace=true}
